...
public class ShackleFeelerController implements OnCheckedChangeListener {
  ...
  public ShackleFeelerController(SocialBikeActivity activity, Resources res) {
    mActivity = activity;
    mOffBackground = res
  ...
  public void attachToView(ViewGroup targetView) {
    ...
    SpannableStringBuilder ssb = new SpannableStringBuilder(
      mActivity.getString(R.string.shackle_feeler));
  ...
  public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
    ...
    if (mActivity != null) {
      mActivity.sendCommand(SocialBikeActivity.ANSWER_LOCK_STATUS,
                            isChecked ? 1 : 0);
    }
  }
