...
//	ArrayList<SwitchDisplayer> mSwitchDisplayers;
	...
	InputController(SocialBikeActivity hostActivity) {
		super(hostActivity);
	}
...
//		}
	...
	public void setShackleStatus(int shackleStatusFromArduino) {
...
*/
	public void onShackleChanged(int shackle) {
		setShackleStatus(shackle);
	}
/*
