...
public class ADKBikeActivity extends Activity implements Runnable {
  ...
  private static final String TAG                   = "ADKBikeActivity";
    ...
    saveButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (editText != null) {
          ...
          sendToAdk(editText.getText());

        } else {

          Log.i(TAG, "editText == null");
        }
      }
    });
  }

  private void sendToAdk(Editable text) {
  ...
  protected void handleTemperatureMessage(TemperatureMsg t) {
    Log.i(TAG, "handleTemperatureMessage" + t);
  }


  protected void handleSwitchMessage(SwitchMsg o) {

    Log.i(TAG, "handleSwitchMessage: " + o);
